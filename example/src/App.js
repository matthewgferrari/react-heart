...
export function Heart({ isActive, onClick, animationTrigger = "click", animationScale = 1.05, inactiveColor = "black", activeColor = "red", className, style }) {

  return (
    <Svg style={style} onClick={() => onClick(!isActive)} viewBox="0 0 16 16" className={className} animationTrigger={animationTrigger} animationScale={animationScale} xmlns="http://www.w3.org/2000/svg">
      {isActive ?
